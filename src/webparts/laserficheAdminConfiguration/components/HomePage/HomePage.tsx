        ...
        <main className='bg-white shadow-sm' style={{ width: '80%' }}>
          <div className='p-3'>
            <p className='adminContent'>
              The Laserfiche Administration page lets you edit your SharePoint
              and Laserfiche configuration. Sign in and select the task you want
              to perform from the menu on the top of this section.
            </p>
            <p className='adminContent'>
              ...
              <div className='adminContent'>
                ...
                <p style={{ marginLeft: '38px' }}>
                  <span>
                    ...
                    SharePoint content types. For example, you may want
                    applications stored differently than invoices, and thus
                    you’ll create separate profiles for each.
                  </span>
                </p>
                <p>
                ...
                <p style={{ marginLeft: '38px' }}>
                  <span>
                    In this tab, you can map a specific SharePoint content type
                    with a corresponding Laserfiche profile. This profile will
                    then be used when saving all documents of the specified
