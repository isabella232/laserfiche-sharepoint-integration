...
export default class LaserficheAdminConfiguration extends React.Component<ILaserficheAdminConfigurationProps, {}> {
  ...
  public render(): React.ReactElement<ILaserficheAdminConfigurationProps> {
    return (
      <HashRouter>
        <Stack>
          <AdminMainPage context={this.props.context} webPartTitle={this.props.webPartTitle} laserficheRedirectPage={this.props.laserficheRedirectPage} region={this.props.region} ></AdminMainPage>
          <StackItem>
            <Switch>
              ...
              <Route exact={true} component={() => <AddNewManageConfiguration context={this.props.context} laserficheRedirectPage={this.props.laserficheRedirectPage} region={this.props.region} />} path="/AddNewManageConfiguration" >
              </Route>
              <Route exact={true} render={(props) => <EditManageConfiguration {...props} context={this.props.context} laserficheRedirectPage={this.props.laserficheRedirectPage} region={this.props.region} />} path="/EditManageConfiguration/:name" >
              </Route>
            </Switch>
          </StackItem>
        </Stack>
